...
from infrastructure.detectors.pii_pl import BaseNerDetector
...
def get_anonymizer_service(
    pii_pl_detector: BaseNerDetector = Depends(get_pii_pl_detector),
...
_SLOW_DETECTOR_TYPES = (BaseNerDetector, GazetteerDetector)
